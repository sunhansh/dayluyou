	...
	<div style='text-align: center;'>
	  <h1>修改人员信息</h1>
		<el-row>
		  ...
		  <el-col :span="12"> <el-input style='width:300px;margin-top: 20px;' placeholder='请输入用户名称' v-model='username'></el-input> </el-col>
	...
	export default {
		...
		methods: {
		  saveEdit(){
				...
				username:this.username,password:this.password,telno:this.telno,sex:this.sex,compid:this.compid};
